...
pub async fn authenticate_and_get_stream_id(url: &str, stream_key: &str, client: &Client) -> Result<String, ServerSessionError> {
    let response: StreamUserResponse = get_authentication(url, stream_key, client).await
